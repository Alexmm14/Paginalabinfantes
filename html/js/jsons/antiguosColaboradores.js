...
var rutaJSON = 'JSON/antiguosColab.json';
...
fetch(rutaJSON)
    ...
    .then(jsonArray => {
        ...
        var informacionContainer = document.getElementById('informacion-container6');
        ...
        jsonArray.forEach(jsonInfo => {
            ...
            <div class="card">
                <div class="card-header" id="subseccion6-${num}">
                    <button class="btn btn-link btn-linkcolor" type="button" data-toggle="collapse" data-target="#subcontenido6-${num}" aria-expanded="true">
                        ${jsonInfo.nombre}
                    </button>
                </div>

                <div id="subcontenido6-${num}" class="collapse" aria-labelledby="subseccion6-${num}" data-parent="#contenido6">
                    <div class="card-body">
                        <div class="row">
