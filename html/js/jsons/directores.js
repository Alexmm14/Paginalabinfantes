    ...
    .then(jsonArray => {
        ...
        <div class="card">
            <div class="card-header" id="subseccion1-${num}">
                <button class="btn btn-link btn-linkcolor" type="button" data-toggle="collapse" data-target="#subcontenido1-${num}" aria-expanded="true">
                    ${jsonInfo.nombre}
                </button>
            </div>

            <div id="subcontenido1-${num}" class="collapse" aria-labelledby="subseccion2-${num}" data-parent="#contenido3">
                <div class="card-body">
                    <div class="row">
